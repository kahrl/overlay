...
src_prepare() {
	epatch "${FILESDIR}"/${P}-bbox-extended.patch
}
...
pkg_postinst() {
	ewarn "This is an unsupported third-party patched version of poppler."
	ewarn "It adds several options to the pdftotext command line utility."
	ewarn
